import os
# OKAY
api_key =os.environ.get('ECO_INF_API_KEY')  # Google API - "auyon-zach-second"
...
census_api_key =os.environ.get('ECO_INF_CENSUS_API_KEY')  #new 02/04/2021
mapquest_api_key =os.environ.get('ECO_INF_MAPQUEST_API_KEY') 
mapquest_api_secret =os.environ.get('ECO_INF_MAPQUEST_API_SECRET') 

geoapify_api_key =os.environ.get('ECO_INF_GEOAPIFY_API_KEY') 

mapbox_api_key =os.environ.get('ECO_INF_MAPBOX_API_KEY') 

top_dir = "/Users/zach/UCLA Anderson Dropbox/Zach Siegel/UCLA_classes/research/Polling"
...
census_acs_block_group_file = f'{census_prefetch_dir}/Georgia_block_group_ACS5.csv'
census_acs_block_group_file_raw = f'{census_prefetch_dir}/Georgia_block_group_ACS5_raw.csv'
