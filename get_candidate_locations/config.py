import os
# okay
api_key = os.environ.get('GET_CANDIDATE_LOCATIONS_API_KEY')    # GOOGLE API - Auyon/Nic
api_key2 = os.environ.get('GET_CANDIDATE_LOCATIONS_API_KEY2') # Google API - Zach
census_api_key = os.environ.get('GET_CANDIDATE_LOCATIONS_CENSUS_API_KEY') # CENSUS API
geocoding_api_key = os.environ.get('GET_CANDIDATE_LOCATIONS_GEOCODING_API_KEY') #GEOCODING API
geocoding_api_key2 = os.environ.get('GET_CANDIDATE_LOCATIONS_GEOCODING_API_KEY2') # Geocoding API - Zach
